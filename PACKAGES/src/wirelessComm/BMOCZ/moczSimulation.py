...
from wirelessComm.CHANNEL import SlowFadingChannel
...
class moczSIMULATION:
    ...
    def msgGen(self, i): # i is userId used as seed
        rng = random.Random(i)
        return [rng.randint(0,1) for _ in range(self.pktSize)]
